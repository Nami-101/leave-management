...
namespace LeaveManagementSystemCore.Controllers
{
    ...
    public class LeaveRequestController : Controller
    {
        ...
        {
            var user = await _userManager.GetUserAsync(User); // Set user first
            ...
            // Log ModelState errors for debugging (detailed)
            foreach (var modelState in ModelState)
            {
                foreach (var error in modelState.Value.Errors)
                {
                    Console.WriteLine($"Model Error: Key = {modelState.Key}, Error = {error.ErrorMessage}");
                }
            }
